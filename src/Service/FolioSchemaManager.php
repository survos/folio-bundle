...
use Survos\FolioBundle\Entity\{Core,Folio,Relation,RelationType,Row,Term,TermSet};

final class FolioSchemaManager
{
    private const array ENTITIES = [Folio::class, Core::class, Row::class, TermSet::class, Term::class, RelationType::class, Relation::class];
    ...
    public function update(EntityManagerInterface $em): void
    {
        ...
        (new SchemaTool($em))->updateSchema($metas, true);
