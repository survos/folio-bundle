 ...
 * App\Entity\Folio::$code via FolioCodeAssigner).
 *
 * Not implementing this in an app is fine: FolioContextListener treats a
 * missing resolver as "slug routing unavailable" and 404s slug URLs while
 * leaving the existing /{provider}/{dataset}/... routes untouched. See
